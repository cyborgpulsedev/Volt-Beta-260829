...
contextBridge.exposeInMainWorld("voltDesktop", {
  ...
  exportDir: () => ipcRenderer.invoke("volt:export-dir"),
  setExportDir: (dir) => ipcRenderer.invoke("volt:set-export-dir", dir),
  nextExportDir: (dir) => ipcRenderer.invoke("volt:next-export-dir", dir),
  pickExportDir: () => ipcRenderer.invoke("volt:pick-export-dir"),
